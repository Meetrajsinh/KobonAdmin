...
namespace KobonAdmin.Controllers
{
    public class WalletsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "WalletId,Amount,AccountId")] Wallet wallet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "WalletId,Amount,AccountId")] Wallet wallet)
        {
            if (ModelState.IsValid)
            {
